...
- Bard spellcasting with level-gated known spells and slots, including free `Vicious Mockery`, combat spells like `Healing Word`, `Dissonant Whispers`, and `Faerie Fire`, social quest spells like `Charm Person` and first-pass `Suggestion`, plus `Invisibility` as a stealth preparation, monster-zone, and calm-room dungeon tool
