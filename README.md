...
- first-pass monster zone beyond the outer wall with visible objectives, tracked landmarks that become easier to find across different visit days and eventually unlock direct travel from the gate, Perception/Stealth awareness checks, abstract encounter distance, camp safety, pack-animal monster oddity hauling, Wall Watch/Guard Station reactions, and defeated-creature reports that let Dorr book delayed captured-monster ring contracts
