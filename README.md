...
- quest approach menus where non-combat story quests and day jobs list several skill-based methods, let the player read the scene for guidance, and keep distinct flavor text for each approach
...
- an expensive town magic-item shop that previews AC, stat, and once-per-combat advantage/disadvantage items before monster-part crafting comes online
