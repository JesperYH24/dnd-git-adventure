...
- reusable quest-approach helpers for listing multiple skill-based methods, optional `Read the scene` guidance, and approach-specific success/failure flavor across non-combat story quests and day jobs
