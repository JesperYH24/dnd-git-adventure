...
function Initialize-TownQuests {
    return @(
        (New-TownQuest -Id "guard_night_watch" -Name "Night Watch Relief" -Source "Guard Station" -Description "The guards need a capable arm on a short night patrol through the outer district." -Objective "Report to the watch captain for an evening patrol." -QuestType "Story" -Tier 1 -RewardCopper 180 -RewardXP 120)
        (New-TownQuest -Id "patron_storehouse_rats" -Name "Storehouse Trouble" -Source "Quest Giver" -Description "A merchant patron wants someone to clear vermin and thieves from a locked riverside storehouse." -Objective "Meet the patron's clerk and investigate the storehouse." -QuestType "Story" -Tier 1 -RewardCopper 150 -RewardXP 120 -RewardItemName "Healing Potion")
        (New-TownQuest -Id "quest_board_missing_herbs" -Name "Missing Herb Satchel" -Source "Quest Board" -Description "A local herbalist needs a satchel recovered from the old road beyond the city wall." -Objective "Search the old road and return the satchel." -QuestType "Story" -Tier 1 -RewardCopper 120 -RewardXP 40)
        (New-TownQuest -Id "patron_ledger_of_ash" -Name "Ledger of Ash" -Source "Quest Giver" -Description "A merchant clerk suspects false entries and hush money in a ledger tied to missing goods." -Objective "Question the clerk, inspect the ledger, and trace the irregular payments." -QuestType "Story" -Tier 2 -RewardCopper 140 -RewardXP 90)
        (New-TownQuest -Id "guard_night_courier" -Name "Night Courier Intercept" -Source "Guard Station" -Description "The watch believes a marked courier is moving messages between the city's surface contacts and the understreet routes." -Objective "Intercept the night courier and secure whatever they are carrying." -QuestType "Story" -Tier 2 -RewardCopper 150 -RewardXP 90)
        (New-TownQuest -Id "bent_nail_whispers" -Name "Whispers Beneath the Bent Nail" -Source "Bent Nail" -Description "A back-room fixer at the Bent Nail knows more about the city's quiet cargo routes than any honest merchant should." -Objective "Follow the broker lead inside the Bent Nail and learn where the smugglers are moving goods." -QuestType "Story" -Tier 2 -RewardCopper 130 -RewardXP 90)
        ...
        (New-TownQuest -Id "docks_charter_scribe" -Name "The Charter Scribe" -Source "Docks" -Description "The dockside organization survives because someone makes dirty freight look lawful. Lady Veyra needs the charter scribe found before the Civic Vault trail can open." -Objective "Find the scribe who cleans the organization's papers and crack its legal shield before the Civic Vault arc." -QuestType "Story" -Tier 4 -DocksTier 3 -RewardCopper 260 -RewardXP 300)
        ...
        (New-TownQuest -Id "dayjob_market_delivery_4" -Name "Market Runner: Wall Supply Run" -Source "Quest Board" -Description "Outer-wall rumors have turned ordinary supply runs into guard logistics. The market needs a trusted runner to move lamp oil, bandages, and salted food without starting a panic." -Objective "Move wall supplies through the market and keep the handoff calm." -QuestType "DayJob" -RewardCopper 175 -DayJobTrackId "market_runner" -DayJobStep 4 -RequiredHeroLevel 4)
        (New-TownQuest -Id "dayjob_market_delivery_5" -Name "Market Runner: Monster Proof Auction" -Source "Quest Board" -Description "Dorr's monster proof has buyers sniffing around the market, and the runners need someone who can move sealed samples before rumor inflates the price." -Objective "Carry sealed monster-zone samples through the market and keep buyers, guards, and gawkers from ruining the handoff." -QuestType "DayJob" -RewardCopper 210 -DayJobTrackId "market_runner" -DayJobStep 5 -RequiredHeroLevel 5)
        (New-TownQuest -Id "dayjob_market_delivery_6" -Name "Market Runner: Evacuation Tokens" -Source "Quest Board" -Description "With the gate under real threat, the market runners are issuing evacuation tokens, ration marks, and wall-shelter passes before the next alarm bell." -Objective "Distribute emergency tokens quickly and prevent the market from turning fear into a crush." -QuestType "DayJob" -RewardCopper 245 -DayJobTrackId "market_runner" -DayJobStep 6 -RequiredHeroLevel 6)
        ...
        (New-TownQuest -Id "dayjob_gate_labor_4" -Name "Gate Duty: Wall-Watch Shift" -Source "Guard Station" -Description "The Wall Watch needs extra discipline at the gate now that outer-road reports mention bigger tracks and stranger howls." -Objective "Help the gate detail inspect incoming wagons, organize the line, and keep the wall-watch lane clear." -QuestType "DayJob" -RewardCopper 185 -DayJobTrackId "gate_labor" -DayJobStep 4 -RequiredHeroLevel 4)
        (New-TownQuest -Id "dayjob_gate_labor_5" -Name "Gate Duty: Refugee Wagons" -Source "Guard Station" -Description "Outer farms are sending frightened wagons toward the city, and the gate needs someone trusted enough to separate panic from real monster signs." -Objective "Clear refugee wagons through the gate while protecting the wall-watch route." -QuestType "DayJob" -RewardCopper 225 -DayJobTrackId "gate_labor" -DayJobStep 5 -RequiredHeroLevel 5)
        (New-TownQuest -Id "dayjob_gate_labor_6" -Name "Gate Duty: Breach Drill" -Source "Guard Station" -Description "After the first organized attacks, the gate detail is drilling for another breach and needs a field-tested hand to keep civilians and guards moving in the right lanes." -Objective "Run a breach drill at the gate and keep the evacuation and reinforcement lanes clear." -QuestType "DayJob" -RewardCopper 265 -DayJobTrackId "gate_labor" -DayJobStep 6 -RequiredHeroLevel 6)
        ...
        (New-TownQuest -Id "dayjob_dock_loading_4" -Name "Dock Work: Wall Timber" -Source "Quest Board" -Description "The docks are loading emergency wall timber and iron braces for the gate crews, and the tide will not wait for frightened laborers." -Objective "Move wall-repair freight from dock to wagon before the tide ruins the schedule." -QuestType "DayJob" -RewardCopper 185 -DayJobTrackId "dock_work" -DayJobStep 4 -RequiredHeroLevel 4)
        (New-TownQuest -Id "dayjob_dock_loading_5" -Name "Dock Work: Oddity Crates" -Source "Quest Board" -Description "Monster oddities from beyond the wall are being sealed, weighed, and argued over on the docks before Dorr's buyers can move them." -Objective "Stabilize the oddity crates and keep river crews from damaging valuable monster-zone proof." -QuestType "DayJob" -RewardCopper 225 -DayJobTrackId "dock_work" -DayJobStep 5 -RequiredHeroLevel 5)
        (New-TownQuest -Id "dayjob_dock_loading_6" -Name "Dock Work: Defense Barges" -Source "Quest Board" -Description "The city is staging defense barges with timber, healing supplies, and spare weapons in case the gate pressure spreads along the river." -Objective "Load the defense barges before the next wall alarm reaches the river quarter." -QuestType "DayJob" -RewardCopper 265 -DayJobTrackId "dock_work" -DayJobStep 6 -RequiredHeroLevel 6)
        ...
        (New-TownQuest -Id "dayjob_scribe_copy_4" -Name "Scribe Work: Wall Reports" -Source "Quest Giver" -Description "Lady Veyra's clerks need clean wall-watch summaries from frightened reports, monster signs, and guard claims that do not agree yet." -Objective "Prepare wall-watch report copies that the city can act on without spreading panic." -QuestType "DayJob" -RewardCopper 175 -DayJobTrackId "scribe_work" -DayJobStep 4 -RequiredHeroLevel 4)
        (New-TownQuest -Id "dayjob_scribe_copy_5" -Name "Scribe Work: Creature Ledgers" -Source "Quest Giver" -Description "Monster-zone proof has started producing ledgers of teeth, scales, tracks, and witness claims that need a reliable hand before buyers and guards argue them useless." -Objective "Organize creature-proof ledgers so Dorr, the watch, and the clerks can trust the same records." -QuestType "DayJob" -RewardCopper 215 -DayJobTrackId "scribe_work" -DayJobStep 5 -RequiredHeroLevel 5)
        (New-TownQuest -Id "dayjob_scribe_copy_6" -Name "Scribe Work: Defense Orders" -Source "Quest Giver" -Description "After the gate defense, orders, casualty notes, temple supply lists, and wall-repair claims all need clean copies before the city forgets who held the line." -Objective "Prepare defense-order copies and preserve the names, supplies, and duties that matter after the attack." -QuestType "DayJob" -RewardCopper 255 -DayJobTrackId "scribe_work" -DayJobStep 6 -RequiredHeroLevel 6)
    )
}
...
function Get-StoryClueProgressSummary {
    ...
    if ([bool]$Game.Town.StoryFlags["UnderstreetComplexCleared"]) {
        ...
        if ([bool]$Game.Town.StoryFlags["DocksCharterScribeExposed"]) {
            return "Chapter Three Notes: The dockside organization has lost the scribe who made its dirty work look legal. $($Game.Hero.Name) is ready to grow before the Civic Vault arc."
        }
