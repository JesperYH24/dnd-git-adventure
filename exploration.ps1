        ...
        while ($true) {
            ...
            switch ($choice) {
                ...
                "S" {
                    ...
                    $displayXP = [Math]::Min($Game.Hero.XP, $nextLevelXP)
                    $unarmedTrainingLevel = 0

                    if ($null -ne $Game.Hero.PSObject.Properties["UnarmedTrainingLevel"]) {
                        $unarmedTrainingLevel = [int]$Game.Hero.UnarmedTrainingLevel
                    }
